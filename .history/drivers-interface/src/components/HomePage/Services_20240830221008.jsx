                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="bg-white rounded-lg shadow-md overflow-hidden">
                        ...
                        <div className="p-6 text-center">
                            ...
                            Lorem ipsum odor amet, consectetuer adipiscing elit. Laoreet consectetur neque lacus blandit bibendum cras sociosqu. Phasellus tellus sagittis bibendum eget
                            </p>
                        </div>
                    </div>
                    <div className="bg-white rounded-lg shadow-md overflow-hidden">
                        ...
                        <div className="p-6 text-center">
                            ...
                            <p className="text-gray-700 text-base">
                            Our gram flour is perfect for a variety of uses, including baking, cooking, and making snacks. It is also a good source of protein and fiber. Our gram flour grinding service is a convenient and affordable way to get the freshest gram flour possibleLorem ipsum odor amet, consectetuer adipiscing elit. Laoreet consectetur neque lacus blandit bibendum cras sociosqu. Phasellus tellus sagittis bibendum eget
                            </p>
                        </div>
                    </div>
                    <div className="bg-white rounded-lg shadow-md overflow-hidden">
                        ...
                        <div className="p-6 text-center">
                            ...
                            <p className="text-gray-700 text-base">
                            Our jowar grinding service is a convenient and affordable way to get fresh, high-quality jowar flour. We use state-of-the-art equipment to grind jowar into a fine powder, which is perfect for making roti, bread, and other dishesLorem ipsum odor amet, consectetuer adipiscing elit. Laoreet consectetur neque lacus blandit bibendum cras sociosqu. Phasellus tellus sagittis bibendum eget
                                <details>
                    ...
                    <div className="bg-white rounded-lg shadow-md overflow-hidden">
                        ...
                        <div className="p-6 text-center">
                            ...
                            <p className="text-gray-700 text-base">
                                ...
                                <details>
                                    <summary>Read More</summary>
                                    <p>Lorem ipsum odor amet, consectetuer adipiscing elit. Laoreet consectetur neque lacus blandit bibendum cras sociosqu. Phasellus tellus sagittis bibendum eget</p>
                                </details>
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-lg shadow-md overflow-hidden">
                        ...
                        <div className="p-6 text-center">
                            ...
                            <p className="text-gray-700 text-base">
                                ...
                                <details>
                                    <summary>Read More</summary>
                                    <p>We offer a variety of rice papad flavors, including plain, salted, spicy, and flavored. We also offer a variety of sizes and shapes to choose from. Our papad is available in bulk or in individual packages.</p>
                                </details>
                            </p>
                        </div>
                    </div>
