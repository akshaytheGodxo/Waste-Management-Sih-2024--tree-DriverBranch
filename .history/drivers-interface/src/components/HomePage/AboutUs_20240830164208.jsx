                            ...
                            <div className="px-4 py-6 transform transition duration-500 hover:scale-110">
                                ...
                                <img
                                    src="https://image3.jdomni.in/banner/13062021/58/97/7C/E53960D1295621EFCB5B13F335_1623567851299.png?output-format=webp"
                                        className="w-32 mb-3"
                                        style={{
                                        filter: 'invert(39%) sepia(31%) saturate(382%) hue-rotate(83deg) brightness(89%) contrast(91%)'}}alt="SVG Image"
    />
                                </div>
                                <h2 className="title-font font-regular text-2xl text-gray-900">AI Based Segregation</h2>
                            </div>
                        </div>
                        ...
                        <div className="p-4 md:w-1/4 sm:w-1/2">
                            <div className="px-4 py-6 transform transition duration-500 hover:scale-110">
                                ...
                                <img
                                    ...
                                    className="w-32 mb-3"
                                    style={{
                                    filter: 'invert(39%) sepia(31%) saturate(382%) hue-rotate(83deg) brightness(89%) contrast(91%)'}}alt="Reasonable Rates"
    />                          
                                </div>
                        ...
                        <div className="p-4 md:w-1/4 sm:w-1/2">
                            <div className="px-4 py-6 transform transition duration-500 hover:scale-110">
                                ...
                                <img
                                    ...
                                    alt="Time Efficiency"
        style={{
            filter: 'invert(50%) sepia(60%) saturate(200%) hue-rotate(120deg) brightness(90%) contrast(85%)'
        }}
    />
                                </div>
