  ...
  return (
    ...
    <div className="absolute inset-9 flex flex-col md:flex-row items-center justify-between">
        <div className="md:w-1/2 mb-4 md:mb-0">
            <h1 className="font-bold text-4xl md:text-5xl leading-tight mb-2">Avrutti</h1>
            <p className="font-bold text-xl mb-8 mt-4">One stop solution for Waste Management Services</p>
            <a href="#contactUs"
